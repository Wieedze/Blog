...
[ARP](/projects/arp), Agent Reputation Protocol, is the project I'm most excited about right now, and the one most likely to humble me. The MVP shipped this week for the MetaMask Snap Smart Wallet hackathon.

It didn't come from nowhere. After ETHGlobal Cannes I started thinking seriously about agent reputation and worked it out in two posts: [the wrapper problem](/journal/wrapper-problem) (reputation should flow through the tools an agent uses, not stop at the agent) and [attribution as graph traversal](/journal/attribution-graph-traversal), a two-layer way to make that honest and auditable. ARP is the attempt to actually build it.
