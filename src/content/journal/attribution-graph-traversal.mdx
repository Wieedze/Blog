...
*The follow-up to [the wrapper problem](/journal/wrapper-problem), and part of the thinking that led to [ARP](/projects/arp). Originally posted on the [Intuition Atlas Discourse](https://atlas.discourse.group/t/a-two-layer-model-for-attributing-reputation-across-agent-compositions/1261) reposted here for the journal.*
